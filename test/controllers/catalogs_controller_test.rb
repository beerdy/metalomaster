...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { description: @catalog.description, image_name: @catalog.image_name, image_uid: @catalog.image_uid, slave: @catalog.slave, sort: @catalog.sort, title: @catalog.title, url: @catalog.url }
    end
  ...
  test "should update catalog" do
    patch :update, id: @catalog, catalog: { description: @catalog.description, image_name: @catalog.image_name, image_uid: @catalog.image_uid, slave: @catalog.slave, sort: @catalog.sort, title: @catalog.title, url: @catalog.url }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
